    ...
    function(emote, player)
        ...
        if RP.Shared[emote] ~= nil then
            if RP.Shared[emote].AnimationOptions and RP.Shared[emote].AnimationOptions.Attachto then
                ...
                if
                    not targetEmote or not RP.Shared[targetEmote] or not RP.Shared[targetEmote].AnimationOptions or
                        not RP.Shared[targetEmote].AnimationOptions.Attachto
                 then
                    ...
                    AttachEntityToEntity(
                        ply,
                        pedInFront,
                        GetPedBoneIndex(pedInFront, bone),
                        xPos,
                        yPos,
                        zPos,
                        xRot,
...
AddEventHandler(
    ...
    function(emotename, etype, target)
        isRequestAnim = true
