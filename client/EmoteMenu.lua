...
function AddInfoMenu(menu)
    ...
    infomenu =
        _menuPool:AddSubMenu(menu, Config.Languages[lang]["infoupdate"], "Huge Thank You ❤️", "", Menuthing, Menuthing)
    -- else
    ...
    -- end
    infomenu:AddItem(
        NativeUI.CreateItem(Config.Languages[lang]["suggestions"], Config.Languages[lang]["suggestionsinfo"])
    )
    infomenu:AddItem(
        NativeUI.CreateItem(
            'Join the <font color="#00ceff">Discord 💬</font>',
    ...
    infomenu:AddItem(
        NativeUI.CreateItem(
            'Thanks <font color="#A6A333">Scullyy 👨‍💻</font>',
