...
RegisterNetEvent(
    "rpemotes:ptfx:sync",
    function(asset, name, offset, rot, bone, scale, color)
...
local function addKeybindEventHandlers()
    RegisterNetEvent(
        ...
        function()
            ...
            MySQL.query(
                "SELECT * FROM dpkeybinds WHERE `id`=@id;",
                {id = srcid},
                function(dpkeybinds)
    ...
    RegisterNetEvent(
        ...
        function(key, emote)
            ...
            if chosenk == "keybind1" then
                MySQL.update(
                    "UPDATE dpkeybinds SET emote1=@emote WHERE id=@id",
                    {id = myid, emote = emote},
                    function()
            ...
            elseif chosenk == "keybind2" then
                MySQL.update(
                    "UPDATE dpkeybinds SET emote2=@emote WHERE id=@id",
                    {id = myid, emote = emote},
                    function()
                        TriggerClientEvent("rp:ClientKeybindGetOne", src, key, emote)
                    end
            ...
            elseif chosenk == "keybind3" then
                MySQL.update(
                    "UPDATE dpkeybinds SET emote3=@emote WHERE id=@id",
                    {id = myid, emote = emote},
                    function()
                        TriggerClientEvent("rp:ClientKeybindGetOne", src, key, emote)
                    end
            ...
            elseif chosenk == "keybind4" then
                MySQL.update(
                    "UPDATE dpkeybinds SET emote4=@emote WHERE id=@id",
                    {id = myid, emote = emote},
                    function()
                        TriggerClientEvent("rp:ClientKeybindGetOne", src, key, emote)
                    end
            ...
            elseif chosenk == "keybind5" then
                MySQL.update(
                    "UPDATE dpkeybinds SET emote5=@emote WHERE id=@id",
                    {id = myid, emote = emote},
                    function()
                        TriggerClientEvent("rp:ClientKeybindGetOne", src, key, emote)
                    end
            ...
            elseif chosenk == "keybind6" then
                MySQL.update(
                    "UPDATE dpkeybinds SET emote6=@emote WHERE id=@id",
                    {id = myid, emote = emote},
                    function()
                        TriggerClientEvent("rp:ClientKeybindGetOne", src, key, emote)
                    end
...
if Config.SqlKeybinding and MySQL then
    ...
    print(
        "[rp] ^3Sql Keybinding^7 is turned ^1off^7, if you want to enable /emotebind, set ^3SqlKeybinding = ^2true^7 in config.lua and uncomment oxmysql lines in fxmanifest.lua."
    )
end
