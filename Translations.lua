Config.Languages = {
    ['sq'] = { -- Albanian
		...
		['infoupdateavtext'] = "Ka një përditësim të disponueshëm, merrni versionin e fundit nga ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['ar'] = { -- Arabic
        ...
        ['infoupdateavtext'] = "يوجد تحديث جديد متاح , قم بالحصول عليه من هنا : ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['pt'] = { -- Brazilian Portuguese 🇧🇷
        ...
        ['infoupdateavtext'] = "Uma atualização disponível, veja ~y~https://github.com/Tnoxious/nox-rpemotes~w~ para pegar",
    ...
    ['zhcn'] = {  -- Chinese simplified
        ...
        ['infoupdate'] = "致谢 🤝🏻",
        ['infoupdateav'] = "信息 (有更新)",
        ['infoupdateavtext'] = "已有新版本可用，请前往 ~y~https://github.com/Tnoxious/nox-rpemotes~w~ 获取最新版。",
        ['suggestions'] = "想提出建议？",
    ...
    ['zhtw'] = { -- Chinese Traditional
        ...
        ['infoupdate'] = "致謝 🤝🏻",
        ['infoupdateav'] = "信息 (有更新)",
        ['infoupdateavtext'] = "已有新版本可用，請前往 ~y~https://github.com/Tnoxious/nox-rpemotes~w~ 獲取最新版。",
        ['suggestions'] = "想提出建議？",
    ...
    ['cs'] = { -- Czech 🇨🇿
        ...
        ['infoupdateavtext'] = "Je k dispozici aktualizace, stáhněte si nejnovější verzi z ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Nápady?",
    ...
    ['da'] = { -- Danish 🇩🇰
        ...
        ['infoupdateavtext'] = "En opdatering er tilgænglig, hent den nyeste version fra ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Forslag?",
        ...
        ['puke'] = "Tryk ~y~G~w~ for at kaste op", ---- Translated fixes by iplayer1337fivem
		['cut'] = "Press ~y~G~w~ to cut",
        ['btn_select'] = "Vælg",
        ['btn_back'] = "Tilbage",
        ['btn_switch'] = "Bevægelse",
        ['btn_increment'] = "Stigning"
        ['dead'] = "Du kan ikke bruge følelser, mens du er død!",
        ['swimming'] = "Du kan ikke bruge følelser, mens du svømmer",
        ['notvalidpet'] = "RUH ROH! Forkert ped-model fundet 🐕!",
        ['animaldisabled'] = "Undskyld! Dyrefølelser er deaktiveret på denne server",
        ['adultemotedisabled'] = "Bonk! Voksne følelser deaktiveret 🔞",
        ['toggle_instructions'] = "Skift instruktionerne",
        ['exit_binoculars'] = "Forlad kikkerten",
        ['toggle_binoculars_vision'] = "Skift mellem synstilstande",
        ['exit_news'] = "Afslut nyhedskamera",
        ['toggle_news_vision'] = "Skift mellem synstilstande",
        ['edit_values_newscam'] = "Rediger nyhedsteksten",
        ['not_in_a_vehicle'] = "Du kan ikke afspille denne animation, mens du er i et køretøj",
        ['in_a_vehicle'] = "Du kan kun afspille denne animation, mens du er i et køretøj 🚷",
        ['no_anim_crawling'] = "Du kan ikke afspille animationer, mens du crawler",
        ['no_anim_right_now'] = "Du kan ikke afspille en animation lige nu",
    },
    ['nl'] = { -- Dutch 🇳🇱
        ...
        ['infoupdateavtext'] = "Een update is beschikbaar, download de laatste versie via ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['en'] = { -- English 🇬🇧
        ...
        ['infoupdateavtext'] = "An update is available, get the latest version from ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['fi'] = { -- Finnish 🇫🇮
        ...
        ['infoupdateavtext'] = "Uusin versio saatavilla täältä ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['fr'] = { -- French 🇫🇷
        ...
        ['infoupdateavtext'] = "Une mise à jour est disponible ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Suggestions?",
    ...
    ['de'] = { -- German 🇩🇪
        ...
        ['infoupdateavtext'] = "Eine Aktualisierung ist verfügbar ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
	...
	['el'] = { -- Greek 🇬🇷
        ...
        ['infoupdateavtext'] = "Υπάρχει νέα έκδοση διαθέσιμη, κατέβασέτην από εδώ ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['hu'] = { -- Hungarian 🇭🇺
        ...
        ['infoupdateavtext'] = "A frissítés elérhető, a legfrissebb verziót a következő címen tudod beszerezni ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['it'] = { -- Italian 🇮🇹
        ...
        ['infoupdateavtext'] = "Un aggiornamento è disponibile, ottieni l'ulima versione qui ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['no'] = { -- Norwegian 🇳🇴
        ...
        ['infoupdateavtext'] = "En oppdatering er tilgjengelig, du finner den nyeste versjonen her: ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Forslag?",
    ...
    ['fa'] = { -- persian 🇮🇷
        ...
        ['infoupdateavtext'] = "update jadid vojod darad baray daryaft ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['pl'] = { -- Polish 🇵🇱
        ...
        ['infoupdateavtext'] = "Dostępna jest nowa aktualizacja, pobierz ją z: ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['ru'] = { -- Russian 🇷🇺
        ...
        ['infoupdateavtext'] = "Доступно обновление, загрузите последнюю версию с ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['lk'] = { -- Sinhala 🇱🇰
        ...
        ['infoupdateavtext'] = "Update ekak tiyanawa, alutma update eka methanin ganna ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Suggestions?",
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ on FiveM forums for any feature/emote suggestions! ✉️",
    ...
    ['es'] = { -- Spanish 🇪🇸
        ...
        ['infoupdateavtext'] = "Hay una actualización disponible, para conseguir la ultima version ingrese a ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['sv'] = { -- Swedish 🇸🇪
        ...
        ['infoupdateavtext'] = "En uppdatering är tillgänglig ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Förslag?",
    ...
    ['tr'] = { -- Turkish 🇹🇷
        ...
        ['infoupdateavtext'] = "Bir güncelleme mevcuttur, en son sürümü şu adresten edinin ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['id'] = { -- Indonesian 🇮🇩
        ...
        ['infoupdateavtext'] = "Pembaruan tersedia, dapatkan versi terbaru dari ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
        ['suggestions'] = "Saran?",
    ...
    ['lt'] = { -- Lithuanian (LT)
        ...
        ['infoupdateavtext'] = "Galimas naujinimas, gaukite naujausia versija is ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['sr'] = { -- Serbian
        ...
        ['infoupdateavtext'] = "Ažuriranje je dostupno, skini zadnju verziju sa ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
    ...
    ['sl'] = { -- Slovenia
		...
		['infoupdateavtext'] = "Na voljo je posodobitev, pridobite najnovejšo različico s spletne strani ~y~https://github.com/Tnoxious/nox-rpemotes~w~",
